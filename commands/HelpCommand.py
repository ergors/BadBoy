...
class HelpCommand(CommandBase):
    ...
    async def execute(self, client, message, args):
        ...
        embed.add_field(name="!ping", value="Ping some target.", inline=False)
        embed.add_field(name="!hibp", value="Check if your email got leaked.", inline=False)
        ...
        embed.add_field(name="!sqli", value="Test if a url is vulnerable to SQLi.", inline=False)
        embed.add_field(name="!shodan", value="Search host in shodan.", inline=False)
        embed.add_field(name="!exploitdb", value="Search exploits in ExploitDB.", inline=False)
        embed.add_field(name="!reverseip", value="Verify domains in a host.", inline=False)
